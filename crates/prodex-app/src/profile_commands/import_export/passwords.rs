...
pub(super) fn resolve_export_password() -> Result<Zeroizing<String>> {
    ...
    print_stderr_line("Profile Export: enter a password for the encrypted profile bundle.")?;
    let password = Zeroizing::new(
        rpassword::prompt_password("Export password: ")
    ...
    let confirmation = Zeroizing::new(
        rpassword::prompt_password("Confirm export password: ")
...
pub(super) fn resolve_import_password() -> Result<String> {
    ...
    print_stderr_line("Profile Import: enter the password for this encrypted profile bundle.")?;
