...
pub(super) fn runtime_smart_context_repo_state_text_observation(
    text: &str,
    command: Option<&str>,
...
pub(super) fn runtime_smart_context_repo_state_test_command(value: &str) -> Option<String> {
...
pub(super) fn runtime_smart_context_repo_state_merge_spans(
