...
#[cfg(test)]
pub(super) fn runtime_smart_context_apply_artifact_aliases_to_generated_texts(
...
pub(super) fn runtime_smart_context_apply_artifact_aliases_to_generated_texts_with_state(
    value: &mut serde_json::Value,
...
pub(super) fn runtime_smart_context_generated_artifact_ref_counts(
...
pub(super) fn runtime_smart_context_generated_artifact_ref_counts_from_value(
    value: &serde_json::Value,
...
pub(super) fn runtime_smart_context_artifact_alias_plan(
...
pub(super) fn runtime_smart_context_stable_artifact_alias_candidate(
    state: &mut RuntimeSmartContextProxyState,
    id: &str,
...
pub(super) fn runtime_smart_context_commit_stable_artifact_alias(
    state: &mut RuntimeSmartContextProxyState,
    id: &str,
    alias: &str,
) {
...
pub(super) fn runtime_smart_context_artifact_alias_index(alias: &str) -> Option<usize> {
    alias.strip_prefix('@')?.parse::<usize>().ok()
}

pub(super) fn runtime_smart_context_persisted_artifact_aliases(
...
pub(super) fn runtime_smart_context_artifact_alias_state_from_persisted(
...
pub(super) fn runtime_smart_context_merge_persisted_artifact_aliases(
...
pub(super) fn runtime_smart_context_replace_generated_artifact_refs_with_aliases(
    value: &mut serde_json::Value,
...
pub(super) fn runtime_smart_context_generated_control_line(line: &str) -> bool {
...
pub(super) fn runtime_smart_context_insert_artifact_alias_legend(
    value: &mut serde_json::Value,
    aliases: &[RuntimeSmartContextArtifactAlias],
) -> bool {
...
pub(super) fn runtime_smart_context_artifact_alias_legend(
    aliases: &[RuntimeSmartContextArtifactAlias],
) -> String {
    let defs = aliases
        .iter()
...
pub(super) fn runtime_smart_context_insert_artifact_alias_legend_in_value(
    value: &mut serde_json::Value,
    legend: &str,
) -> bool {
    match value {
...
pub(super) fn runtime_smart_context_insert_artifact_alias_legend_in_text(
    text: &str,
    legend: &str,
) -> String {
...
pub(super) fn runtime_smart_context_apply_path_aliases_to_generated_texts(
    value: &mut serde_json::Value,
) -> bool {
    match value {
        serde_json::Value::String(text)
...
pub(super) fn runtime_smart_context_path_aliased_generated_text(text: &str) -> Option<String> {
...
pub(super) fn runtime_smart_context_path_aliases(text: &str) -> Vec<(String, String)> {
...
pub(super) fn runtime_smart_context_repeated_path_prefix(token: &str) -> Option<String> {
