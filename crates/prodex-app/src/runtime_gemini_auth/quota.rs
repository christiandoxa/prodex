use super::code_assist::{
    fetch_gemini_code_assist_plan, gemini_code_assist_endpoint, gemini_validation_error_message,
    gemini_validation_from_body, resolve_gemini_code_assist_project_with_endpoint,
};
use super::{
