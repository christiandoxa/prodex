...
pub(super) struct OpenAiTunnelStatus {
    pub(super) tunnel_id: String,
    pub(super) client_version: String,
}

pub(super) struct OpenAiTunnelCredentials {
    tunnel_id: String,
...
impl OpenAiTunnelCredentials {
    pub(super) fn new(tunnel_id: impl Into<String>, api_key: impl Into<String>) -> Result<Self> {
...
pub(super) struct OpenAiTunnel {
    ...
    pub(super) status: OpenAiTunnelStatus,
...
pub(super) fn resolve_openai_tunnel_id(explicit: Option<&str>) -> Result<String> {
    let value = explicit
        .map(str::to_owned)
...
pub(super) fn ensure_openai_tunnel_available(tunnel_id: &str) -> Result<String> {
    validate_openai_tunnel_id(tunnel_id)?;
...
pub(super) fn openai_tunnel_client_command() -> Result<Command> {
