...
use prodex_provider_core::{
    ...
    deepseek_provider_core_stream_fallback_response_id, deepseek_provider_core_stream_first_choice,
...
impl RuntimeDeepSeekSseState {
    ...
    pub(super) fn new_with_provider(
        ...
        Self {
            provider_kind,
            request_id,
            response_id: deepseek_provider_core_stream_fallback_response_id(
