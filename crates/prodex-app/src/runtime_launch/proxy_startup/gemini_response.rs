...
const GEMINI_INTERNAL_INSTRUCTION_LEAK_PREFIXES: &[&str] = &[
    ...
    "If `SUPER_OPTIMIZERS_WANTS_CLAUDE_MEM`",
...
const GEMINI_INTERNAL_INSTRUCTION_LEAK_MARKERS: &[&str] = &[
    ...
    "SUPER_OPTIMIZERS_WANTS_CLAUDE_MEM",
...
pub(in super::super) fn runtime_gemini_internal_instruction_corpus(
...
pub(in super::super) fn runtime_gemini_text_echoes_internal_instruction(
    text: &str,
