...
pub use audit::{
    ...
    AuditReasonCodeError, AuditReasonDetail, AuditReasonDetailError, AuditResource,
    AuditResourceId, AuditResourceIdError, AuditResourceKindError, AuditRetentionBatchLimit,
    AuditRetentionBatchLimitError, AuditRetentionDecision, AuditRetentionDecisionError,
    AuditRetentionHold, AuditRetentionHoldError, AuditRetentionPageError, AuditRetentionPlan,
    AuditRetentionPlanError, AuditRetentionPolicy, AuditRetentionPolicyError,
    AuditRetentionPurgeBatch, AuditRetentionPurgeBatchError, AuditRetentionPurgeKey,
    AuditSortOrder, AuditSortOrderError, AuditTimeRange, AuditTimeRangeError, AuditTimestamp,
    AuditTimestampError, compute_audit_chain_digest, normalize_audit_reason_detail,
