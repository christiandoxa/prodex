...
pub(crate) fn validate_gateway_observability_http_schema(value: &str) -> Result<()> {
    #[cfg(feature = "mojo")]
    {
        ...
        if !prodex_mojo_core::policy::validate_text(
            value,
            prodex_mojo_core::policy::PolicyTextKind::ObservabilitySchema,
        )
        .expect("Mojo runtime-policy text validation returned invalid output")
        {
...
pub(crate) fn validate_gateway_state_backend(value: &str) -> Result<()> {
    #[cfg(feature = "mojo")]
    {
        ...
        if !prodex_mojo_core::policy::validate_text(
            value,
            prodex_mojo_core::policy::PolicyTextKind::StateBackend,
        )
        .expect("Mojo runtime-policy text validation returned invalid output")
        {
...
pub(crate) fn validate_gateway_admin_role(value: &str) -> Result<()> {
    #[cfg(feature = "mojo")]
    {
        ...
        if !prodex_mojo_core::policy::validate_text(
            value,
            prodex_mojo_core::policy::PolicyTextKind::AdminRole,
        )
        .expect("Mojo runtime-policy text validation returned invalid output")
        {
...
pub(crate) fn validate_gateway_guardrail_webhook_phase(value: &str) -> Result<()> {
    #[cfg(feature = "mojo")]
    {
        ...
        if !prodex_mojo_core::policy::validate_text(
            value,
            prodex_mojo_core::policy::PolicyTextKind::WebhookPhase,
        )
        .expect("Mojo runtime-policy text validation returned invalid output")
        {
