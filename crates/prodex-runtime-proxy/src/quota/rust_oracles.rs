...
pub(super) fn summary_from_usage_snapshot_at(
...
pub(super) fn window_summary_from_usage_snapshot_at(
...
pub(super) fn usage_snapshot_hold_active(snapshot: RuntimeProxyUsageSnapshot, now: i64) -> bool {
    [
...
pub(super) fn usage_snapshot_hold_expired(snapshot: RuntimeProxyUsageSnapshot, now: i64) -> bool {
    [
        (snapshot.five_hour_status, snapshot.five_hour_reset_at),
        (snapshot.weekly_status, snapshot.weekly_reset_at),
    ]
...
pub(super) fn usage_snapshot_is_usable(
    snapshot: RuntimeProxyUsageSnapshot,
    now: i64,
...
pub(super) fn summary_requires_precommit_live_probe(
...
pub(super) fn summary_requires_live_source_after_probe(
    summary: RuntimeProxyQuotaSummary,
    source: Option<RuntimeSelectionQuotaSource>,
    route_kind: RuntimeRouteKind,
) -> bool {
...
pub(super) fn precommit_quota_block_reason(
    summary: RuntimeProxyQuotaSummary,
    route_kind: RuntimeRouteKind,
...
pub(super) fn precommit_quota_gate_initial_decision(
...
pub(super) fn precommit_quota_gate_final_decision(
