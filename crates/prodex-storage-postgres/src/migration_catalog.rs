...
pub const GOVERNANCE_INVALIDATION_OUTBOX_MIGRATION: PostgresMigration = PostgresMigration {
    version: PostgresMigrationVersion(17),
    phase: PostgresMigrationPhase::Expand,
    name: "017_governance_invalidation_outbox",
    sql: r#"
