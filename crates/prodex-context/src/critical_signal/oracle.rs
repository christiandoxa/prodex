...
mod rust_compat {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_critical_signal_counts_for_line(line: &str) -> CriticalSignalCounts {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_unprefix_numbered_critical_line(line: &str) -> &str {
    ...
    pub(crate) fn critical_signal_line_multiset(input: &str) -> BTreeMap<String, usize> {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn critical_signal_line_key(line: &str) -> String {
        line.trim().to_string()
    }

    #[cfg(not(feature = "mojo"))]
    pub(crate) fn critical_signal_range_around_line(
        line_index: usize,
        line_count: usize,
        context_lines: usize,
    ...
    #[cfg(not(feature = "mojo"))]
    pub(crate) fn merge_critical_signal_ranges(
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_is_error_signal_line(line: &str) -> bool {
        let trimmed = line.trim_start();
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_contains_jsonish_error_key(line: &str) -> bool {
        line.contains("\"error\"")
            || line.contains("'error'")
            || line.contains("\\\"error\\\"")
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_count_file_location_signals(line: &str) -> usize {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_token_contains_file_location(token: &str) -> bool {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_contains_python_file_location(line: &str) -> bool {
        let trimmed = line.trim_start();
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_contains_paren_file_location(line: &str) -> bool {
        line.split_whitespace()
            .any(rust_token_contains_paren_file_location)
    }

    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_token_contains_paren_file_location(token: &str) -> bool {
        let token = token.trim_matches(|ch: char| {
            matches!(ch, '"' | '\'' | '`' | ',' | ';' | '[' | ']' | '{' | '}')
        });
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_looks_like_location_path(path: &str) -> bool {
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_is_diff_hunk_line(line: &str) -> bool {
        let trimmed = line.trim_start();
        trimmed.starts_with("@@ ") && trimmed[3..].contains("@@")
    }

    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_is_test_failure_signal_line(line: &str) -> bool {
        let trimmed = line.trim_start();
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_is_stack_signal_line(line: &str) -> bool {
        let trimmed = line.trim_start();
    ...
    #[cfg(any(not(feature = "mojo"), test))]
    pub(crate) fn rust_is_diagnostic_signal_line(line: &str) -> bool {
        let trimmed = line.trim_start();
