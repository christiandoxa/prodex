...
mod rust_compat {
    ...
    pub fn plan_provider_metric(
        ...
        #[cfg(feature = "mojo")]
        let provider_label =
            crate::planning_support::planned_metric_label(50, 0, (provider) as i64)?;
        #[cfg(not(feature = "mojo"))]
    ...
    pub fn plan_provider_capability_negotiation_metric(
        ...
        #[cfg(feature = "mojo")]
        let provider_label =
            crate::planning_support::planned_metric_label(47, 0, (provider) as i64)?;
        #[cfg(not(feature = "mojo"))]
        let provider_label = crate::planning_support::validated_metric_label(
            crate::planning_support::label_key(103, "provider"),
            provider_kind_label(provider),
    ...
    pub fn plan_provider_retry_metric(
        ...
        #[cfg(feature = "mojo")]
        let provider_label =
            crate::planning_support::planned_metric_label(51, 0, (provider) as i64)?;
        #[cfg(not(feature = "mojo"))]
        let provider_label = crate::planning_support::validated_metric_label(
            crate::planning_support::label_key(103, "provider"),
            provider_kind_label(provider),
    ...
    pub fn plan_provider_circuit_breaker_metric(
        ...
        #[cfg(feature = "mojo")]
        let provider_label =
            crate::planning_support::planned_metric_label(48, 0, (provider) as i64)?;
        #[cfg(not(feature = "mojo"))]
        let provider_label = crate::planning_support::validated_metric_label(
            crate::planning_support::label_key(103, "provider"),
            provider_kind_label(provider),
        ...
        #[cfg(feature = "mojo")]
        let decision_label =
            crate::planning_support::planned_metric_label(48, 1, (decision) as i64)?;
        #[cfg(not(feature = "mojo"))]
    ...
    pub fn plan_provider_degradation_metric(
        ...
        #[cfg(feature = "mojo")]
        let provider_label =
            crate::planning_support::planned_metric_label(49, 0, (provider) as i64)?;
        #[cfg(not(feature = "mojo"))]
        let provider_label = crate::planning_support::validated_metric_label(
            crate::planning_support::label_key(103, "provider"),
            provider_kind_label(provider),
        ...
        #[cfg(feature = "mojo")]
        let severity_label =
            crate::planning_support::planned_metric_label(49, 2, (severity) as i64)?;
        #[cfg(not(feature = "mojo"))]
    ...
    pub fn plan_streaming_lifecycle_metric(
        ...
        #[cfg(feature = "mojo")]
        let transport_label =
            crate::planning_support::planned_metric_label(53, 0, (transport) as i64)?;
        #[cfg(not(feature = "mojo"))]
