...
mod rust_compat {
    ...
    pub(crate) fn runtime_proxy_anthropic_tool_use_server_tool_usage_rust(
    ...
    pub(crate) fn runtime_proxy_anthropic_carried_server_tool_usage_rust(
    ...
    pub(crate) fn runtime_proxy_anthropic_register_server_tools_from_messages_rust(
        messages: &[serde_json::Value],
        ...
        for message in messages {
            ...
            for block in blocks {
                ...
                let response_name =
                    runtime_proxy_anthropic_builtin_server_tool_name_rust(tool_name)
                        .unwrap_or(tool_name);
    ...
    pub(crate) fn runtime_proxy_anthropic_message_has_tool_chain_blocks_rust(
