...
pub fn runtime_anthropic_message_id() -> String {
    format!("msg_{}", runtime_random_token("claude").replace('-', ""))
}

pub fn runtime_anthropic_error_type_for_status(status: u16) -> &'static str {
    match status {
...
pub fn runtime_anthropic_error_message_from_parts(parts: &RuntimeBufferedResponseParts) -> String {
...
pub fn build_runtime_anthropic_error_parts(
    status: u16,
    error_type: &str,
    message: &str,
...
pub fn runtime_anthropic_error_from_upstream_parts(
