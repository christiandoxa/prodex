...
pub struct RuntimeAnthropicCollectedToolUse {
    call_id: String,
    name: String,
    arguments: String,
    saw_delta: bool,
...
#[derive(Debug, Clone, Default)]
pub struct RuntimeAnthropicCollectedResponse {
...
pub fn runtime_anthropic_response_event_item(
    value: &serde_json::Value,
) -> Option<&serde_json::Value> {
    value.get("item")
}

pub fn runtime_anthropic_output_item_type(item: &serde_json::Value) -> Option<&str> {
    item.get("type").and_then(serde_json::Value::as_str)
}

pub fn runtime_anthropic_output_item_call_id<'a>(
...
pub fn runtime_anthropic_output_item_name<'a>(
    item: &'a serde_json::Value,
    default: &'static str,
) -> &'a str {
    item.get("name")
...
pub fn runtime_anthropic_response_event_error_message(value: &serde_json::Value) -> &str {
    value
        .get("error")
...
pub fn runtime_anthropic_response_from_sse_bytes_with_carried_usage(
    body: &[u8],
    requested_model: &str,
    want_thinking: bool,
