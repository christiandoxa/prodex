...
pub fn runtime_anthropic_usage_from_value(value: &serde_json::Value) -> (u64, u64, Option<u64>) {
...
pub fn runtime_anthropic_tool_usage_web_search_requests_from_value(
...
pub fn runtime_anthropic_tool_usage_tool_search_requests_from_value(
    value: &serde_json::Value,
) -> u64 {
    value
        .get("tool_usage")
...
pub fn runtime_anthropic_tool_usage_code_execution_requests_from_value(
    value: &serde_json::Value,
) -> u64 {
    value
        .get("tool_usage")
...
pub fn runtime_anthropic_server_tool_registration_for_call(
    tool_name: &str,
...
pub fn runtime_anthropic_server_tool_name_for_call(
    tool_name: &str,
    server_tools: Option<&RuntimeAnthropicServerTools>,
) -> Option<String> {
...
pub fn runtime_anthropic_output_item_server_tool_usage(
...
pub fn runtime_anthropic_web_search_request_count_from_output_item(
    item: &serde_json::Value,
) -> u64 {
...
pub fn runtime_anthropic_web_search_request_count_from_output(
...
pub fn runtime_anthropic_web_fetch_request_count_from_output(
    output: &[serde_json::Value],
    server_tools: Option<&RuntimeAnthropicServerTools>,
) -> u64 {
    output
...
pub fn runtime_anthropic_tool_search_request_count_from_output(
    output: &[serde_json::Value],
    server_tools: Option<&RuntimeAnthropicServerTools>,
) -> u64 {
    output
...
pub fn runtime_anthropic_code_execution_request_count_from_output(
    output: &[serde_json::Value],
    server_tools: Option<&RuntimeAnthropicServerTools>,
) -> u64 {
    output
