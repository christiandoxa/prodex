...
pub fn runtime_anthropic_json_response_parts(
...
pub fn runtime_response_body_looks_like_sse(body: &[u8]) -> bool {
    let trimmed = body
        .iter()
        .copied()
...
pub fn runtime_buffered_response_ids(parts: &RuntimeBufferedResponseParts) -> Vec<String> {
...
pub fn runtime_anthropic_message_needs_server_tool_followup(value: &serde_json::Value) -> bool {
...
pub fn runtime_anthropic_message_server_tool_usage(
    value: &serde_json::Value,
...
pub fn runtime_anthropic_message_from_buffered_responses_parts_with_carried_usage(
...
pub fn runtime_anthropic_sse_response_parts_from_responses_sse_bytes(
    body: &[u8],
    requested_model: &str,
    want_thinking: bool,
...
pub fn buffer_runtime_streaming_response_parts(
