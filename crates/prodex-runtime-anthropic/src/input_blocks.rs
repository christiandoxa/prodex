...
pub fn runtime_proxy_anthropic_image_data_url(block: &serde_json::Value) -> Option<String> {
...
pub fn runtime_proxy_translate_anthropic_document_text(
    block: &serde_json::Value,
) -> Option<String> {
    let source = block.get("source")?;
...
pub fn runtime_proxy_translate_anthropic_text_from_block(
    block: &serde_json::Value,
) -> Option<String> {
...
pub fn runtime_proxy_translate_anthropic_block_fallback_text(
    block: &serde_json::Value,
) -> Option<String> {
...
pub fn runtime_proxy_translate_anthropic_mcp_approval_response(
    block: &serde_json::Value,
...
pub fn runtime_proxy_translate_anthropic_message_content(
    role: &str,
...
pub fn runtime_proxy_translate_anthropic_user_content_blocks(
