...
fn request_policy_error(
    ...
    Some(match plan.tag {
        ...
        _ => panic!(
            "Mojo DeepSeek request-field policy returned unknown tag {}",
            plan.tag
        ),
    })
}
...
pub fn deepseek_provider_core_reject_unsupported_request_fields(
    ...
    rust_compat::reject_unsupported_request_fields_rust(value, provider_label)
}
...
pub fn deepseek_provider_core_reject_beta_completion_fields(
    ...
    #[cfg(feature = "mojo")]
    {
        ...
        match plan.tag {
            ...
            tag => panic!("Mojo DeepSeek beta-field policy returned unknown tag {tag}"),
        }
    }
    #[cfg(not(feature = "mojo"))]
    rust_compat::reject_beta_completion_fields_rust(value, provider_label)
}
...
mod rust_compat {
    ...
    pub(super) fn reject_beta_completion_fields_rust(
        value: &serde_json::Value,
        provider_label: &str,
    ) -> Result<(), String> {
