...
mod rust_compat {
    ...
    use super::super::sanitize_function_schema;

    pub(crate) fn collapse_schema_union(object: &serde_json::Map<String, Value>) -> Option<Value> {
    ...
    pub(crate) fn sanitized_composition(value: Option<&Value>) -> Option<Value> {
    ...
    pub(crate) fn has_composition(object: &serde_json::Map<String, Value>) -> bool {
        ["anyOf", "oneOf", "allOf"]
            .iter()
