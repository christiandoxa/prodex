...
mod rust_compat {
    ...
    pub(crate) fn gemini_provider_core_builtin_tool(tool: &serde_json::Value) -> bool {
        let tool_type = tool
            .get("type")
    ...
    pub(crate) fn gemini_provider_core_builtin_tool_choice(value: &serde_json::Value) -> bool {
