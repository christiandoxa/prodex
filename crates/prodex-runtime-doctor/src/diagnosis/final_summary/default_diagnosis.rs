...
fn runtime_doctor_proxy_pressure_diagnosis(summary: &RuntimeDoctorSummary) -> Option<String> {
    ...
    {
        return Some("Recent websocket DNS resolution overflow queueing was observed.".to_string());
    }
    None
}

fn runtime_doctor_websocket_connect_diagnosis(summary: &RuntimeDoctorSummary) -> Option<String> {
