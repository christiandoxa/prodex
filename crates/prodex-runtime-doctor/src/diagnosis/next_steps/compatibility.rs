...
mod rust_compat {
    ...
    pub(crate) fn runtime_doctor_active_pressure_next_step(
        summary: &RuntimeDoctorSummary,
    ) -> String {
        let load =
    ...
    pub(crate) fn runtime_doctor_sync_probe_skip_next_step(
        summary: &RuntimeDoctorSummary,
    ) -> String {
    ...
    pub(crate) fn runtime_doctor_transport_backoff_next_step(
        summary: &RuntimeDoctorSummary,
    ) -> String {
        let scope =
    ...
    pub(crate) fn runtime_doctor_quota_pressure_next_step(
        summary: &RuntimeDoctorSummary,
    ) -> String {
    ...
    pub(crate) fn runtime_doctor_precommit_budget_next_step(
        summary: &RuntimeDoctorSummary,
    ) -> String {
        let route =
