...
pub(super) fn runtime_doctor_active_pressure_next_step(summary: &RuntimeDoctorSummary) -> String {
    let load =
...
pub(super) fn runtime_doctor_sync_probe_skip_next_step(summary: &RuntimeDoctorSummary) -> String {
...
pub(super) fn runtime_doctor_transport_backoff_next_step(summary: &RuntimeDoctorSummary) -> String {
    let scope =
...
pub(super) fn runtime_doctor_quota_pressure_next_step(summary: &RuntimeDoctorSummary) -> String {
...
pub(super) fn runtime_doctor_precommit_budget_next_step(summary: &RuntimeDoctorSummary) -> String {
