...
fn runtime_doctor_summarizes_smart_context_autopilot_roi_and_reasons() {
    let log = br#"
[2026-05-04T00:00:00Z] smart_context_autopilot request=1 transport=http route=responses tier=large decision=rewritten reasons=- token_usage_source=responses_api body_bytes_before=12000 body_bytes_after=4000 self_check=shrunk budget_mode=artifact_condensed policy_reasons=tight_budget artifacts_stored=1
[2026-05-04T00:00:01Z] smart_context_autopilot request=2 transport=http route=responses tier=condensed decision=self_check_passthrough reasons=- token_usage_source=responses_api body_bytes_before=8000 body_bytes_after=8000 self_check=critical_signal_loss budget_mode=minimal_refs_only policy_reasons=critical_budget
[2026-05-04T00:00:02Z] smart_context_autopilot request=3 transport=websocket route=websocket tier=exact decision=require_exact reasons=previous_response,turn_state token_usage_source=unknown body_bytes_before=6000 body_bytes_after=6000 self_check=pass_through_exact budget_mode=exact_pass_through policy_reasons=exactness_required
...
fn runtime_doctor_parses_json_smart_context_autopilot_fields() {
    let line = r#"{"timestamp":"2026-05-04T00:00:00Z","message":"smart_context_autopilot request=9 decision=rewritten body_bytes_before=100 body_bytes_after=20","fields":{"body_bytes_saved":80,"budget_mode":"artifact_condensed","policy_reasons":"tight_budget,moderate_budget","self_check":"shrunk","available_tokens":2500}}"#;
