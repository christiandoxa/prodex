...
mod tests {
    ...
    #[test]
    fn gemini_request_field_plan_selects_canonical_aliases() {
        let plan = gemini_request_field_plan(
            (1 << 0) | (1 << 3) | (1 << 4),
            (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4) | (1 << 21) | (1 << 22),
            (1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4),
        )
        .unwrap();
        ...
        assert_eq!(
            ...
            vec![
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::Temperature,
                    source_index: 0,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::StopSequences,
                    source_index: 3,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::TopK,
                    source_index: 7,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::PresencePenalty,
                    source_index: 10,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::CandidateCount,
                    source_index: 27,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::SafetySettings,
                    source_index: 29,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::CachedContent,
                    source_index: 31,
                },
                GeminiRequestField {
                    target: GeminiRequestFieldTarget::Labels,
                    source_index: 33,
                },
            ]
        );
