...
## Log event classification ABI v4
...
Mojo validates each address before constructing its typed pointer. The address form is internal to
the Rust/Mojo boundary: no Rust or Mojo object layout crosses it, and the supported release targets
are 64-bit.
