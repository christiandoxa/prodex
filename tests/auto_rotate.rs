...
fn run_prodex_with_env(
    ...
    Command::new(env!("CARGO_BIN_EXE_prodex"))
        ...
        .env("PRODEX_RUNTIME_BROKER_READY_TIMEOUT_MS", "15000")
        .env("PRODEX_RUNTIME_BROKER_HEALTH_CONNECT_TIMEOUT_MS", "750")
        .env("PRODEX_RUNTIME_BROKER_HEALTH_READ_TIMEOUT_MS", "1500")
