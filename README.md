...
Gateway virtual-key realtime WebSocket sessions fail closed with `501 virtual_key_realtime_not_supported`; Prodex does not accept unbounded frames that cannot be charged and reconciled safely.
