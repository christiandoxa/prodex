...
import {
  ...
  SEMANTIC_DIFF_FIELDS,
  SEMANTIC_FILE_CONTAINS_FIELD,
  WATCHDOG_SCOPE_DIFF,
  buildDiffSummary,
  containsAllResult,
  diffField,
  makeDiff,
  parseCompatScriptArgs,
  renderWatchReport,
  stringArray,
} from "./upstream-compat-common.mjs";
...
function parseArgs(argv) {
  return parseCompatScriptArgs(argv, {
    defaults: {
...
async function main() {
  ...
  const rendered = renderWatchReport(current, diffs, diffSummary);
  if (args.json) {
