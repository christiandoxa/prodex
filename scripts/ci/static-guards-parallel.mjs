...
const steps = [
  ...
  ["mojo-production-share", "scripts/ci/mojo-production-share.mjs", "--check"],
  ["mojo-authority-self-test", "scripts/ci/mojo-authority-guard.mjs", "--self-test"],
  ["mojo-authority", "scripts/ci/mojo-authority-guard.mjs"],
