...
const PROMOTED_FILES = [
  ...
  "crates/prodex-provider-spi/src/capability_mojo.rs",
  "crates/prodex-provider-spi/src/governed_routing.rs",
  "crates/prodex-provider-spi/src/governed_routing/mojo_plan.rs",
