...
The current local binary version in this repo is `0.2.104`, so matching update commands look like this:

```bash
npm install -g @christiandoxa/prodex@0.2.104
cargo install prodex --force --version 0.2.104
```
