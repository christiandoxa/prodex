...
1.97.1. The supply-chain guard rejects removal, unlocked commands, fail-open behavior, or missing
suite coverage.
...
| Exact Rust/MSRV | manifests, workflows, Docker builder, and components use 1.97.1 | `Cargo.toml`; `rust-toolchain.toml`; `Dockerfile` | pass |
