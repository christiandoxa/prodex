...
| deepseek | 4 | translated | true | true | 16/4/2 | translated | passthrough | passthrough | untested | unsupported | unsupported | unsupported | unsupported | unsupported | unsupported |
| gemini | 19 | translated | true | true | 18/14/3 | translated | passthrough | passthrough | untested | passthrough | unsupported | unsupported | unsupported | unsupported | unsupported |
...
- `gemini`: `input[*].content[type!=text]`, `response_format.type`
