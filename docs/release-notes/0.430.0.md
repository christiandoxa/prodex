...
- Optional-tool pins are current for Caveman 2.7.0, RTK 0.49.0,
  Codebase Memory MCP 0.11.0, Playwright MCP 0.0.82, Ponytail 4.10.0,
  and Presidio 2.2.364. Gemini CLI is a separate native-client compatibility
  pin and is not part of the six-tool Optional Tools inventory.
