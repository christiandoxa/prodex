...
- Fix Windows MSVC release linking for the full Mojo archive by isolating only
  compiler-generated duplicate weak `static_string_*` aliases per object before
  archiving; exported Mojo ABI symbols and runtime semantics are unchanged.
