...
| Drill execution | The disposable PostgreSQL/TLS/RLS proof and authenticated AES-256-GCM custom dump/isolated restore drill passed. Final synthetic RPO was 2.076 seconds and restore RTO was 1.506 seconds. | These synthetic values are not approved production RPO/RTO objectives; managed failover, WAL/PITR and regional cutover remain external drills. |
