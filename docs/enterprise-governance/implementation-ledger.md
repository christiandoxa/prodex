...
| P3-08 | Narrow break-glass with expiry and revocation | implemented | Content-free break-glass approvals require independent approval, expire within one hour, can be revoked, bind to exact tenant and audit-retention scope, and authorize only bounded mandatorily audited purge batches |
