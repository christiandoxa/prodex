...
| Control-plane planning | Every governance artifact lifecycle, execution-approval create/consume, and session revocation writes content-free mutation, hash-chain audit and SIEM outbox state atomically. | Governance break-glass activation remains disabled. |
