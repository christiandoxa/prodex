...
#[path = "http_plan/audit.rs"]
mod audit;
use audit::{control_plane_http_audit_json, plan_control_plane_http_audit_correlation};
...
fn control_plane_operation_label(operation: ControlPlaneOperation) -> &'static str {
    match operation {
        ...
        ControlPlaneOperation::PolicyRead => "policy_read",
        ControlPlaneOperation::PolicyCreate => "policy_create",
        ControlPlaneOperation::PolicyValidate => "policy_validate",
        ControlPlaneOperation::PolicySubmit => "policy_submit",
        ControlPlaneOperation::PolicyVote => "policy_vote",
        ControlPlaneOperation::PolicyActivate => "policy_activate",
        ControlPlaneOperation::PolicyRollback => "policy_rollback",
        ControlPlaneOperation::PolicyRevoke => "policy_revoke",
